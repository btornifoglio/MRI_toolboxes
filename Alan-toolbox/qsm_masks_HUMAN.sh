...
if [ "$#" -ne 7 ]; then
	echo '     ===> usage: qsm_masks_HUMAN.sh dirname thr_tube bot_slice top_slice thr_vessels_bubbles thr_vessels sigma'
	echo '     ===> e.g. qsm_make_HUMAN.sh 20190703_AS1/qsm_masks 0.15 64 126 30 10 0.042'
	exit
fi
...
## BUBBLES MASK ##
##################
# ... works well for HUMANs with bubbles and calcifications
